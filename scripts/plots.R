...
data$Line <- factor(data$Line, levels = c("Founding population","Ambient", "Acidification", "Warming", "Greenhouse"))
...
data$Line <- c(rep("Founding ambient", 4), 
                rep("Ambient", 4),
                rep("Acidification", 4),
                rep("Warming", 4),
                rep("Greenhouse F3", 4),
...
data$Line <- factor(data$Line, levels = c("Founding ambient","Ambient", "Acidification", 
                            "Warming","Greenhouse F3", "Greenhouse"))
...
dat$treatment <- c("Greenhouse", "Greenhouse", "Warming", "Warming", "Acidification", "Acidification")
dat$treatment <- factor(dat$treatment, levels = c("Acidification", "Warming", "Greenhouse"))
...
d <- ggplot(dat, aes(x=category, y = estimate, fill=treatment, shape=treatment)) +
  ...
  geom_point(data = subset(dat, treatment == 'Greenhouse'),
...
dat$treatment <- c("Greenhouse", "Warming", "Acidification")
dat$treatment <- factor(dat$treatment, levels = c("Acidification", "Warming", "Greenhouse"))
#dat$cat_share <- factor(dat$cat_share, levels = c("shared_Acidic", "shared_Warm", "shared_Greenhoue","no_lab_Acidic", "no_lab_Warm", "no_lab_Greenhoue"))
...
dat$treatment <- c("Greenhouse vs.\nWarming","Greenhouse vs.\nWarming",
                    "Acidification vs.\nWarming", "Acidification vs.\nWarming",
                    "Greenhouse vs.\nAcidification", "Greenhouse vs.\nAcidification")
...
driftdf <- data.frame(treatment = c("GH", "warm", "acidic"),
...
dat$treatment <- c("Greenhouse","Greenhouse", "Warming", "Warming", "Acidification", "Acidification", "Greenhouse", "Warming", "Acidification")
dat$treatment <- factor(dat$treatment, levels = c("Acidification", "Warming", "Greenhouse"))
#dat$cat_share <- factor(dat$cat_share, levels = c("shared_Acidic", "shared_Warm", "shared_Greenhoue","no_lab_Acidic", "no_lab_Warm", "no_lab_Greenhoue"))
...
dat$labels <- gsub("HH", "Greenhouse",dat$labels)
...
odat <- rbind(odat, tmpdf)
tmpdf <- dat1[which(dat1$pop1 == "Ambient" & dat1$pop2 == "Greenhouse"),]
odat <- rbind(odat, tmpdf)
...
odat <- rbind(odat, tmpdf)
tmpdf <- dat1[which(dat1$pop1 == "Acidification" & dat1$pop2 == "Greenhouse"),]
odat <- rbind(odat, tmpdf)

tmpdf <- dat1[which(dat1$pop1 == "Warming" & dat1$pop2 == "Warming"),]
odat <- rbind(odat, tmpdf)
tmpdf <- dat1[which(dat1$pop1 == "Warming" & dat1$pop2 == "Greenhouse"),]
odat <- rbind(odat, tmpdf)

tmpdf <- dat1[which(dat1$pop1 == "Greenhouse" & dat1$pop2 == "Greenhouse"),]
odat <- rbind(odat, tmpdf)
...
odat$comparison[which(odat$pop1 == "Greenhouse" & odat$pop2 == "Greenhouse")] <- "Greenhouse"

odat$comparison <- factor(odat$comparison, levels=c("Ambient", "Acidification","Warming", "Greenhouse", "inter-line"))
...
odat$comparison[which(odat$pop1 == "Ambient" & odat$pop2 == "Greenhouse")] <- "Ambient vs. Greenhouse"
odat$comparison[which(odat$pop1 == "Acidification" & odat$pop2 == "Acidification")] <- "Acidification"
odat$comparison[which(odat$pop1 == "Acidification" & odat$pop2 == "Warming")] <- "Acidification vs. Warming"
odat$comparison[which(odat$pop1 == "Acidification" & odat$pop2 == "Greenhouse")] <- "Acidification vs. Greenhouse"
odat$comparison[which(odat$pop1 == "Warming" & odat$pop2 == "Warming")] <- "Warming"
odat$comparison[which(odat$pop1 == "Warming" & odat$pop2 == "Greenhouse")] <- "Warming vs. Greenhouse"
odat$comparison[which(odat$pop1 == "Greenhouse" & odat$pop2 == "Greenhouse")] <- "Greenhouse"


odat$comparison <- factor(odat$comparison, levels = c("Ambient", "Ambient vs. Acidification", "Ambient vs. Warming", "Ambient vs. Greenhouse",
                                                        "Acidification", "Acidification vs. Warming", "Acidification vs. Greenhouse",
                                                        "Warming","Warming vs. Greenhouse", "Greenhouse"))
...
odat$comp_cols[which(odat$pop1 == "Greenhouse" & odat$pop2 == "Greenhouse")] <- "Greenhouse"

odat$comp_cols <- as.factor(odat$comp_cols)

odat$comp_cols <- factor(odat$comp_cols, levels=c("Ambient", "Acidification","Warming", "Greenhouse", "inter-line"))
